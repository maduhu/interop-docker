...
RUN if [ "${MULE_VERSION}" != "3.8.0" ] && [ "${MULE_VERSION}" != "3.7.0" ] && [ "${MULE_VERSION}" != "3.6.1" ] && [ "${MULE_VERSION}" != "3.6.0" ]; then echo "-----   Unsupported version: ${MULE_VERSION}   -----" && return 1; fi
